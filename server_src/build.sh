...
build() {
    ...
    make
    if [ $? -eq 0 ]; then
        echo "make msfs_server successed";
    else
        echo "make msfs_server failed";
        exit;
    fi
    ...
    make
    if [ $? -eq 0 ]; then
        echo "make push_client successed";
    else
        echo "make push_client failed";
        exit;
    fi
    ...
    cp msfs_server/msfs_server ../run/msfs_server/

	cp push_client/push_client ../run/push_client/
    ...
    cp msfs_server/msfs_server ../$build_version/msfs_server/
    cp msfs_server/msfsserver.conf ../$build_version/msfs_server/

    cp push_client/push_client ../$build_version/push_client/
    cp push_client/pushclient.conf ../$build_version/push_client/
	...
	cp -a /usr/lib64/libapr-1.so* ../$build_version/lib/
	cp -a /usr/lib64/libaprutil-1.so* ../$build_version/lib/
