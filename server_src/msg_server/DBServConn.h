...
private:
	...
	void _HandleClientAddFriendGroupResponse(CImPdu* pPdu);
	void _HandleClientDelFriendGroupResponse(CImPdu* pPdu);
	void _HandleClientMoveFrinedGroupResponse(CImPdu* pPdu);
	void _HandleClientChgFriendGroupResponse(CImPdu* pPdu);

	void _HandleClientAddFriendRespone(CImPdu* pPdu);
	void _HandleClientReverseAddFriendRespone(CImPdu* pPdu);
	void _HandleClientDelFriendRespone(CImPdu* pPdu);
	void _HandleClientChgFriendRemarkRespone(CImPdu* pPdu);

	void _HandleClientGetAddFriendRespone(CImPdu* pPdu);
	void _HandleClientFindUserInfoRespone(CImPdu* pPdu);

	void _HandleSrvGetFriendsidRespone(CImPdu* pPdu);
