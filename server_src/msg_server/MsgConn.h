...
private:
	...
	void _HandleClientAddFriendRes(CImPdu* pPdu);
	void _HandleClientReverseAddFriendRequest(CImPdu* pPdu);
	void _HandleClientDelFriendRequest(CImPdu* pPdu);
	void _HandleClientChgFriendmarkRequest(CImPdu* pPdu);

	void _HandleClientAddFriendGroupRequest(CImPdu* pPdu);
	void _HandleClientDelFriendGroupRequest(CImPdu* pPdu);
	void _HandleClientMoveFrinedGroupRequest(CImPdu* pPdu);
	void _HandleClientChgFriendGroupRequest(CImPdu* pPdu);

	void _HandleClientFriendNotifyRes(CImPdu* pPdu);

	void _HandleClientGetAddFriendRequest(CImPdu* pPdu);
	void _HandleClientFindUserInfoRequest(CImPdu* pPdu);
...
static uint32_t g_push_id_min;
static uint32_t g_push_id_max;
