...
int main(int argc, char* argv[])
{
	...
	char* str_push_id_min =  config_file.GetConfigName("PUSH_ID_MIN");
	char* str_push_id_max =  config_file.GetConfigName("PUSH_ID_MAX");

	uint32_t push_id_min = atoi(str_push_id_min);
	uint32_t push_id_max = atoi(str_push_id_max);
	...
	init_msg_conn(push_id_min, push_id_max);
