...
cp slog/log4cxx.properties ../run/msfs_server/
cp slog/libslog.so  ../run/msfs_server/
cp slog/lib/liblog4cxx.so.* ../run/msfs_server/

cp slog/log4cxx.properties ../run/push_client/
cp slog/libslog.so  ../run/push_client/
cp slog/lib/liblog4cxx.so.* ../run/push_client/
