...
class IMUserStatusUpdate : public ::google::protobuf::MessageLite {
 public:
  ...
  static const int kUserUidFieldNumber = 10;
...
class IMPushToUserReq : public ::google::protobuf::MessageLite {
 public:
  ...
  inline bool has_push_data() const;
  inline void clear_push_data();
  static const int kPushDataFieldNumber = 2;
  inline const ::std::string& push_data() const;
  inline void set_push_data(const ::std::string& value);
  inline void set_push_data(const char* value);
  inline void set_push_data(const char* value, size_t size);
  inline ::std::string* mutable_push_data();
  inline ::std::string* release_push_data();
  inline void set_allocated_push_data(::std::string* push_data);
 ...
 private:
  ...
  inline void set_has_push_data();
  inline void clear_has_push_data();
...
inline ::IM::BaseDefine::ClientType IMValidateReq::client_type() const {
...
inline void IMValidateReq::set_client_type(::IM::BaseDefine::ClientType value) {
...
// optional string client_ip = 11;
inline bool IMValidateReq::has_client_ip() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
inline void IMValidateReq::set_has_client_ip() {
  _has_bits_[0] |= 0x00000008u;
}
inline void IMValidateReq::clear_has_client_ip() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void IMValidateReq::clear_client_ip() {
  if (client_ip_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    client_ip_->clear();
  }
  clear_has_client_ip();
}
inline const ::std::string& IMValidateReq::client_ip() const {
  // @@protoc_insertion_point(field_get:IM.Server.IMValidateReq.client_ip)
  return *client_ip_;
}
inline void IMValidateReq::set_client_ip(const ::std::string& value) {
  set_has_client_ip();
  if (client_ip_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    client_ip_ = new ::std::string;
  }
  client_ip_->assign(value);
  // @@protoc_insertion_point(field_set:IM.Server.IMValidateReq.client_ip)
}
inline void IMValidateReq::set_client_ip(const char* value) {
  set_has_client_ip();
  if (client_ip_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    client_ip_ = new ::std::string;
  }
  client_ip_->assign(value);
  // @@protoc_insertion_point(field_set_char:IM.Server.IMValidateReq.client_ip)
}
inline void IMValidateReq::set_client_ip(const char* value, size_t size) {
  set_has_client_ip();
  if (client_ip_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    client_ip_ = new ::std::string;
  }
  client_ip_->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:IM.Server.IMValidateReq.client_ip)
}
inline ::std::string* IMValidateReq::mutable_client_ip() {
  set_has_client_ip();
  if (client_ip_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    client_ip_ = new ::std::string;
  }
  // @@protoc_insertion_point(field_mutable:IM.Server.IMValidateReq.client_ip)
  return client_ip_;
}
inline ::std::string* IMValidateReq::release_client_ip() {
  clear_has_client_ip();
  if (client_ip_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    return NULL;
  } else {
...
inline void IMValidateReq::set_allocated_client_ip(::std::string* client_ip) {
  if (client_ip_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    delete client_ip_;
  }
  if (client_ip) {
...
// optional string user_token = 10;
inline bool IMValidateRsp::has_user_token() const {
  return (_has_bits_[0] & 0x00000010u) != 0;
}
inline void IMValidateRsp::set_has_user_token() {
  _has_bits_[0] |= 0x00000010u;
}
inline void IMValidateRsp::clear_has_user_token() {
  _has_bits_[0] &= ~0x00000010u;
}
inline void IMValidateRsp::clear_user_token() {
  if (user_token_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    user_token_->clear();
  }
  clear_has_user_token();
}
inline const ::std::string& IMValidateRsp::user_token() const {
  // @@protoc_insertion_point(field_get:IM.Server.IMValidateRsp.user_token)
  return *user_token_;
}
inline void IMValidateRsp::set_user_token(const ::std::string& value) {
  set_has_user_token();
  if (user_token_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    user_token_ = new ::std::string;
  }
  user_token_->assign(value);
  // @@protoc_insertion_point(field_set:IM.Server.IMValidateRsp.user_token)
}
inline void IMValidateRsp::set_user_token(const char* value) {
  set_has_user_token();
  if (user_token_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    user_token_ = new ::std::string;
  }
  user_token_->assign(value);
  // @@protoc_insertion_point(field_set_char:IM.Server.IMValidateRsp.user_token)
}
inline void IMValidateRsp::set_user_token(const char* value, size_t size) {
  set_has_user_token();
  if (user_token_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    user_token_ = new ::std::string;
  }
  user_token_->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:IM.Server.IMValidateRsp.user_token)
}
inline ::std::string* IMValidateRsp::mutable_user_token() {
  set_has_user_token();
  if (user_token_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    user_token_ = new ::std::string;
  }
  // @@protoc_insertion_point(field_mutable:IM.Server.IMValidateRsp.user_token)
  return user_token_;
}
inline ::std::string* IMValidateRsp::release_user_token() {
  clear_has_user_token();
  if (user_token_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    return NULL;
  } else {
...
inline void IMValidateRsp::set_allocated_user_token(::std::string* user_token) {
  if (user_token_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    delete user_token_;
  }
  if (user_token) {
...
// optional uint32 user_uid = 10;
inline bool IMUserStatusUpdate::has_user_uid() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
inline void IMUserStatusUpdate::set_has_user_uid() {
  _has_bits_[0] |= 0x00000008u;
}
inline void IMUserStatusUpdate::clear_has_user_uid() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void IMUserStatusUpdate::clear_user_uid() {
  user_uid_ = 0u;
  clear_has_user_uid();
}
inline ::google::protobuf::uint32 IMUserStatusUpdate::user_uid() const {
  // @@protoc_insertion_point(field_get:IM.Server.IMUserStatusUpdate.user_uid)
  return user_uid_;
}
inline void IMUserStatusUpdate::set_user_uid(::google::protobuf::uint32 value) {
  set_has_user_uid();
  user_uid_ = value;
...
// required string push_data = 2;
inline bool IMPushToUserReq::has_push_data() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void IMPushToUserReq::set_has_push_data() {
  _has_bits_[0] |= 0x00000002u;
}
inline void IMPushToUserReq::clear_has_push_data() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void IMPushToUserReq::clear_push_data() {
  if (push_data_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    push_data_->clear();
  }
  clear_has_push_data();
}
inline const ::std::string& IMPushToUserReq::push_data() const {
  // @@protoc_insertion_point(field_get:IM.Server.IMPushToUserReq.push_data)
  return *push_data_;
}
inline void IMPushToUserReq::set_push_data(const ::std::string& value) {
  set_has_push_data();
  if (push_data_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    push_data_ = new ::std::string;
  }
  push_data_->assign(value);
  // @@protoc_insertion_point(field_set:IM.Server.IMPushToUserReq.push_data)
}
inline void IMPushToUserReq::set_push_data(const char* value) {
  set_has_push_data();
  if (push_data_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    push_data_ = new ::std::string;
  }
  push_data_->assign(value);
  // @@protoc_insertion_point(field_set_char:IM.Server.IMPushToUserReq.push_data)
}
inline void IMPushToUserReq::set_push_data(const char* value, size_t size) {
  set_has_push_data();
  if (push_data_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    push_data_ = new ::std::string;
  }
  push_data_->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:IM.Server.IMPushToUserReq.push_data)
}
inline ::std::string* IMPushToUserReq::mutable_push_data() {
  set_has_push_data();
  if (push_data_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    push_data_ = new ::std::string;
  }
  // @@protoc_insertion_point(field_mutable:IM.Server.IMPushToUserReq.push_data)
  return push_data_;
}
inline ::std::string* IMPushToUserReq::release_push_data() {
  clear_has_push_data();
  if (push_data_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    return NULL;
  } else {
    ::std::string* temp = push_data_;
    push_data_ = const_cast< ::std::string*>(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
    return temp;
  }
}
inline void IMPushToUserReq::set_allocated_push_data(::std::string* push_data) {
  if (push_data_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    delete push_data_;
  }
  if (push_data) {
  ...
  // @@protoc_insertion_point(field_set_allocated:IM.Server.IMPushToUserReq.push_data)
}
