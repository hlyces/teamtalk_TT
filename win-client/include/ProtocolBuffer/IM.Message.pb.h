...
class IMCleanMsgListReq : public ::google::protobuf::MessageLite {
 public:
  IMCleanMsgListReq();
  virtual ~IMCleanMsgListReq();

  IMCleanMsgListReq(const IMCleanMsgListReq& from);

  inline IMCleanMsgListReq& operator=(const IMCleanMsgListReq& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const IMCleanMsgListReq& default_instance();
  ...
  // for Protobuf internal code. Please use default_instance() declared
  // above instead.
  static inline const IMCleanMsgListReq* internal_default_instance() {
    return default_instance_;
  }
  #endif

  void Swap(IMCleanMsgListReq* other);

  // implements Message ----------------------------------------------

  IMCleanMsgListReq* New() const;
  void CheckTypeAndMergeFrom(const ::google::protobuf::MessageLite& from);
  void CopyFrom(const IMCleanMsgListReq& from);
  void MergeFrom(const IMCleanMsgListReq& from);
  void Clear();
  bool IsInitialized() const;
  ...
  // @@protoc_insertion_point(class_scope:IM.Message.IMCleanMsgListReq)
 private:
  inline void set_has_user_id();
  inline void clear_has_user_id();
  inline void set_has_session_type();
  ...
  void InitAsDefaultInstance();
  static IMCleanMsgListReq* default_instance_;
};
// -------------------------------------------------------------------
...
// required uint32 user_id = 1;
inline bool IMCleanMsgListReq::has_user_id() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void IMCleanMsgListReq::set_has_user_id() {
  _has_bits_[0] |= 0x00000001u;
}
inline void IMCleanMsgListReq::clear_has_user_id() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void IMCleanMsgListReq::clear_user_id() {
  user_id_ = 0u;
  clear_has_user_id();
}
inline ::google::protobuf::uint32 IMCleanMsgListReq::user_id() const {
  // @@protoc_insertion_point(field_get:IM.Message.IMCleanMsgListReq.user_id)
  return user_id_;
}
inline void IMCleanMsgListReq::set_user_id(::google::protobuf::uint32 value) {
  set_has_user_id();
  user_id_ = value;
  // @@protoc_insertion_point(field_set:IM.Message.IMCleanMsgListReq.user_id)
}

// required .IM.BaseDefine.SessionType session_type = 2;
inline bool IMCleanMsgListReq::has_session_type() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void IMCleanMsgListReq::set_has_session_type() {
  _has_bits_[0] |= 0x00000002u;
}
inline void IMCleanMsgListReq::clear_has_session_type() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void IMCleanMsgListReq::clear_session_type() {
  session_type_ = 1;
  clear_has_session_type();
}
inline ::IM::BaseDefine::SessionType IMCleanMsgListReq::session_type() const {
  // @@protoc_insertion_point(field_get:IM.Message.IMCleanMsgListReq.session_type)
  return static_cast< ::IM::BaseDefine::SessionType >(session_type_);
}
inline void IMCleanMsgListReq::set_session_type(::IM::BaseDefine::SessionType value) {
  assert(::IM::BaseDefine::SessionType_IsValid(value));
  set_has_session_type();
  session_type_ = value;
  // @@protoc_insertion_point(field_set:IM.Message.IMCleanMsgListReq.session_type)
}

// required uint32 session_id = 3;
inline bool IMCleanMsgListReq::has_session_id() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void IMCleanMsgListReq::set_has_session_id() {
  _has_bits_[0] |= 0x00000004u;
}
inline void IMCleanMsgListReq::clear_has_session_id() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void IMCleanMsgListReq::clear_session_id() {
  session_id_ = 0u;
  clear_has_session_id();
}
inline ::google::protobuf::uint32 IMCleanMsgListReq::session_id() const {
  // @@protoc_insertion_point(field_get:IM.Message.IMCleanMsgListReq.session_id)
  return session_id_;
}
inline void IMCleanMsgListReq::set_session_id(::google::protobuf::uint32 value) {
  set_has_session_id();
  session_id_ = value;
  // @@protoc_insertion_point(field_set:IM.Message.IMCleanMsgListReq.session_id)
}

// optional bytes attach_data = 20;
inline bool IMCleanMsgListReq::has_attach_data() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
inline void IMCleanMsgListReq::set_has_attach_data() {
  _has_bits_[0] |= 0x00000008u;
}
inline void IMCleanMsgListReq::clear_has_attach_data() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void IMCleanMsgListReq::clear_attach_data() {
  if (attach_data_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    attach_data_->clear();
  }
  clear_has_attach_data();
}
inline const ::std::string& IMCleanMsgListReq::attach_data() const {
  // @@protoc_insertion_point(field_get:IM.Message.IMCleanMsgListReq.attach_data)
  return *attach_data_;
}
inline void IMCleanMsgListReq::set_attach_data(const ::std::string& value) {
  set_has_attach_data();
  if (attach_data_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    attach_data_ = new ::std::string;
  }
  attach_data_->assign(value);
  // @@protoc_insertion_point(field_set:IM.Message.IMCleanMsgListReq.attach_data)
}
inline void IMCleanMsgListReq::set_attach_data(const char* value) {
  set_has_attach_data();
  if (attach_data_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    attach_data_ = new ::std::string;
  }
  attach_data_->assign(value);
  // @@protoc_insertion_point(field_set_char:IM.Message.IMCleanMsgListReq.attach_data)
}
inline void IMCleanMsgListReq::set_attach_data(const void* value, size_t size) {
  set_has_attach_data();
  if (attach_data_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    attach_data_ = new ::std::string;
  }
  attach_data_->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:IM.Message.IMCleanMsgListReq.attach_data)
}
inline ::std::string* IMCleanMsgListReq::mutable_attach_data() {
  set_has_attach_data();
  if (attach_data_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    attach_data_ = new ::std::string;
  }
  // @@protoc_insertion_point(field_mutable:IM.Message.IMCleanMsgListReq.attach_data)
  return attach_data_;
}
inline ::std::string* IMCleanMsgListReq::release_attach_data() {
  clear_has_attach_data();
  if (attach_data_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    return NULL;
  } else {
...
inline void IMCleanMsgListReq::set_allocated_attach_data(::std::string* attach_data) {
  if (attach_data_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    delete attach_data_;
  }
  if (attach_data) {
  ...
  // @@protoc_insertion_point(field_set_allocated:IM.Message.IMCleanMsgListReq.attach_data)
}
