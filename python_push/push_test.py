...
def push_unicast(appkey, app_master_secret, device_token):
  ...
  "device_tokens":device_token,   # 可选 设备唯一表示
  ...
  {
    "display_type":"notification",  # 必填 消息类型，值可以为:
                          ...
                          #        display_type=notification时, body包含如下参数:
    {
        ...
        # 通知到达设备后的提醒方式
        "play_vibrate":"true", # 可选 收到通知是否震动,默认为"true".
                       #注意，"true/false"为字符串
  ...
  "description": "发送消息描述"      # 可选 发送消息描述，建议填写。
...
if __name__ == '__main__':
    appkey = '564bd725e0f55aac2600be43'
    app_master_secret = 'iciicjmgh4l1kygtltmdryhhxlvpcmiy'
    device_token = 'Aqj3_W9KttRfGC2-e8zcxtpXtSV14i9iSAIE5zQYnR0h'
    #device_token = 'AjAHewLLaFVzd9FUj-ID-C48L3pqzffs6xKYWhTLCQkp'
    #device_token = 'AlfgeY6lzrPpblJrJmBLIpPeTQTwxTb-iVBA6xtvqkm5'
