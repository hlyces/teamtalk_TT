...
**push_client:**
	...
	LoginServerUrl=http://192.168.1.49:8080

	UserName=8
	Password=123
	
	#configure for mysql
	DBInstances=teamtalk_master,teamtalk_slave,teamtalk_slave1
	#teamtalk_master
	teamtalk_master_host=127.0.0.1
	teamtalk_master_port=3306
	#teamtalk_master_dbname=teamtalk
	teamtalk_master_dbname=dffx_db_bs
	teamtalk_master_username=root
	teamtalk_master_password=12345
	teamtalk_master_maxconncnt=16
	...
	teamtalk_slave_port=3306
	#teamtalk_slave_dbname=teamtalk
	teamtalk_slave_dbname=dffx_db_bs
	teamtalk_slave_username=root
	teamtalk_slave_password=12345
	teamtalk_slave_maxconncnt=16

	#teamtalk_slave1
	teamtalk_slave1_host=127.0.0.1
	teamtalk_slave1_port=3306
	teamtalk_slave1_dbname=teamtalk
	#teamtalk_slave1_dbname=dffx_db_bs
	teamtalk_slave1_username=root
	teamtalk_slave1_password=12345
	teamtalk_slave1_maxconncnt=16

	#configure for unread
	CacheInstances=unread
	#未读消息计数器的redis
	unread_host=127.0.0.1
	unread_port=6379
	unread_db=1
